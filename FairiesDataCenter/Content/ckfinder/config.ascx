...
<script runat="server">
	...
	public override void SetConfig()
	{
        ...
        type = ResourceType.Add("mp3");
        type.Url = BaseUrl + "mp3/";
        type.MaxSize = 0;
        type.AllowedExtensions = new string[] { "avi", "fla", "flv",  "mid", "mov", "mp3", "mp4", "mpc", "mpeg", "mpg", "rm", "rmi", "rmvb","swf", "wav", "wma", "wmv" };
        type.DeniedExtensions = new string[] { };
        
        //type = ResourceType.Add("快节奏");
        //type.Url = BaseUrl + "mp3/快节奏/";
        //type.Dir = "快节奏";
        //type.MaxSize = 0; 
        //type.AllowedExtensions = new string[] { "7z", "aiff", "asf", "avi", "bmp", "csv", "doc", "docx", "fla", "flv", "gif", "gz", "gzip", "jpeg", "jpg", "mid", "mov", "mp3", "mp4", "mpc", "mpeg", "mpg", "ods", "odt", "pdf", "png", "ppt", "pptx", "pxd", "qt", "ram", "rar", "rm", "rmi", "rmvb", "rtf", "sdc", "sitd", "swf", "sxc", "sxw", "tar", "tgz", "tif", "tiff", "txt", "vsd", "wav", "wma", "wmv", "xls", "xlsx", "zip" };
        //type.DeniedExtensions = new string[] { };

        //type = ResourceType.Add("中节奏");
        //type.Url = BaseUrl + "mp3/中节奏/";
        //type.Dir = "中节奏";
        //type.MaxSize = 0;
        //type.AllowedExtensions = new string[] { "7z", "aiff", "asf", "avi", "bmp", "csv", "doc", "docx", "fla", "flv", "gif", "gz", "gzip", "jpeg", "jpg", "mid", "mov", "mp3", "mp4", "mpc", "mpeg", "mpg", "ods", "odt", "pdf", "png", "ppt", "pptx", "pxd", "qt", "ram", "rar", "rm", "rmi", "rmvb", "rtf", "sdc", "sitd", "swf", "sxc", "sxw", "tar", "tgz", "tif", "tiff", "txt", "vsd", "wav", "wma", "wmv", "xls", "xlsx", "zip" };
        //type.DeniedExtensions = new string[] { };

        //type = ResourceType.Add("慢节奏");
        //type.Url = BaseUrl + "mp3/慢节奏/";
        //type.Dir = "慢节奏";
        //type.MaxSize = 0;
        //type.AllowedExtensions = new string[] { "7z", "aiff", "asf", "avi", "bmp", "csv", "doc", "docx", "fla", "flv", "gif", "gz", "gzip", "jpeg", "jpg", "mid", "mov", "mp3", "mp4", "mpc", "mpeg", "mpg", "ods", "odt", "pdf", "png", "ppt", "pptx", "pxd", "qt", "ram", "rar", "rm", "rmi", "rmvb", "rtf", "sdc", "sitd", "swf", "sxc", "sxw", "tar", "tgz", "tif", "tiff", "txt", "vsd", "wav", "wma", "wmv", "xls", "xlsx", "zip" };
        //type.DeniedExtensions = new string[] { };

        //type = ResourceType.Add("打烊音乐");
        //type.Url = BaseUrl + "mp3/打烊音乐/";
        //type.Dir = "打烊音乐";
        //type.MaxSize = 0;
        //type.AllowedExtensions = new string[] { "7z", "aiff", "asf", "avi", "bmp", "csv", "doc", "docx", "fla", "flv", "gif", "gz", "gzip", "jpeg", "jpg", "mid", "mov", "mp3", "mp4", "mpc", "mpeg", "mpg", "ods", "odt", "pdf", "png", "ppt", "pptx", "pxd", "qt", "ram", "rar", "rm", "rmi", "rmvb", "rtf", "sdc", "sitd", "swf", "sxc", "sxw", "tar", "tgz", "tif", "tiff", "txt", "vsd", "wav", "wma", "wmv", "xls", "xlsx", "zip" };
        //type.DeniedExtensions = new string[] { };

        //type = ResourceType.Add("节假日");
        //type.Url = BaseUrl + "mp3/节假日/";
        //type.Dir = "节假日";
        //type.MaxSize = 0;
        //type.AllowedExtensions = new string[] { "7z", "aiff", "asf", "avi", "bmp", "csv", "doc", "docx", "fla", "flv", "gif", "gz", "gzip", "jpeg", "jpg", "mid", "mov", "mp3", "mp4", "mpc", "mpeg", "mpg", "ods", "odt", "pdf", "png", "ppt", "pptx", "pxd", "qt", "ram", "rar", "rm", "rmi", "rmvb", "rtf", "sdc", "sitd", "swf", "sxc", "sxw", "tar", "tgz", "tif", "tiff", "txt", "vsd", "wav", "wma", "wmv", "xls", "xlsx", "zip" };
        //type.DeniedExtensions = new string[] { };

        //type = ResourceType.Add("新歌");
        //type.Url = BaseUrl + "mp3/新歌/";
        //type.Dir = "新歌";
        //type.MaxSize = 0;
        //type.AllowedExtensions = new string[] { "7z", "aiff", "asf", "avi", "bmp", "csv", "doc", "docx", "fla", "flv", "gif", "gz", "gzip", "jpeg", "jpg", "mid", "mov", "mp3", "mp4", "mpc", "mpeg", "mpg", "ods", "odt", "pdf", "png", "ppt", "pptx", "pxd", "qt", "ram", "rar", "rm", "rmi", "rmvb", "rtf", "sdc", "sitd", "swf", "sxc", "sxw", "tar", "tgz", "tif", "tiff", "txt", "vsd", "wav", "wma", "wmv", "xls", "xlsx", "zip" };
        //type.DeniedExtensions = new string[] { };

        //type = ResourceType.Add("其他");
        //type.Url = BaseUrl + "mp3/其他/";
        //type.Dir = "其他";
        //type.MaxSize = 0;
        //type.AllowedExtensions = new string[] { "7z", "aiff", "asf", "avi", "bmp", "csv", "doc", "docx", "fla", "flv", "gif", "gz", "gzip", "jpeg", "jpg", "mid", "mov", "mp3", "mp4", "mpc", "mpeg", "mpg", "ods", "odt", "pdf", "png", "ppt", "pptx", "pxd", "qt", "ram", "rar", "rm", "rmi", "rmvb", "rtf", "sdc", "sitd", "swf", "sxc", "sxw", "tar", "tgz", "tif", "tiff", "txt", "vsd", "wav", "wma", "wmv", "xls", "xlsx", "zip" };
        //type.DeniedExtensions = new string[] { };
