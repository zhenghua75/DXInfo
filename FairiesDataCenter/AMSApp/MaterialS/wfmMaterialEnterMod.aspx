<%@ Page language="c#" Codebehind="wfmMaterialEnterMod.aspx.cs" AutoEventWireup="false" Inherits="AMSApp.MaterialS.wfmMaterialEnterMod" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>wfmMaterialEnterMod</title>
	...
	<body MS_POSITIONING="GridLayout" bgcolor="#feeff8">
		<FORM id="Form1" method="post" runat="server">
			<TABLE id="Table1" cellSpacing="1" cellPadding="5" width="95%" border="0">
				<TR>
					<TD align="center" style="FONT-WEIGHT: bold; FONT-SIZE: 15pt; COLOR: #330033">原材料入库修正</TD>
				</TR>
			</TABLE>
					...
					<TD>
						<TABLE id="Table2" cellSpacing="0" cellPadding="1" width="100%" border="0">
							...
							<TR>
								...
								<TD style="WIDTH: 127px; HEIGHT: 11px">
									<asp:textbox id="txtMaterialCode" runat="server" Width="136px" Font-Size="10pt" Height="24px"></asp:textbox></TD>
								<TD style="WIDTH: 102px; HEIGHT: 11px" align="right">
								...
								<TD style="WIDTH: 86px; HEIGHT: 11px"></TD>
								<TD style="HEIGHT: 11px"><FONT face="宋体"></FONT></TD>
							</TR>
							<TR>
								<TD align="right" style="WIDTH: 120px">
									<asp:label id="Label4" runat="server" Width="80px" Font-Size="10pt">入库流水</asp:label></TD>
								<TD style="WIDTH: 127px">
									<asp:textbox id="txtEnterSerial" runat="server" Width="136px" Font-Size="10pt" Height="24px"></asp:textbox></TD>
								<TD style="WIDTH: 102px" align="right">
									<asp:label id="Label5" runat="server" Width="79px" Font-Size="10pt">入库开始时间</asp:label></TD>
								<TD style="WIDTH: 125px"><INPUT id=txtBegin onfocus=HS_setDate(this) readOnly type=text size=13 value="<%=strBeginDate%>" name=txtBegin style="WIDTH: 112px; HEIGHT: 22px"></TD>
								<TD style="WIDTH: 101px" align="right">
									<asp:label id="Label6" runat="server" Width="79px" Font-Size="10pt">入库结束时间</asp:label></TD>
								<TD style="WIDTH: 118px"><INPUT id=txtEnd style="WIDTH: 112px; HEIGHT: 22px" onfocus=HS_setDate(this) readOnly type=text size=13 value="<%=strEndDate%>" name=txtEnd></TD>
				...
				<TR>
					<TD align="center">
						<asp:datagrid id="DataGrid1" runat="server" Width="100%" Font-Size="X-Small" BorderColor="Black"
							...
							<Columns>
								<asp:BoundColumn DataField="cnnSerialNo" ReadOnly="True" HeaderText="入库流水"></asp:BoundColumn>
								...
								<asp:BoundColumn Visible="False" DataField="cnnLastCount" ReadOnly="True" HeaderText="入库前数量"></asp:BoundColumn>
								<asp:BoundColumn DataField="cnnEnterCount" HeaderText="入库数量"></asp:BoundColumn>
								<asp:BoundColumn DataField="cndEnterDate" ReadOnly="True" HeaderText="入库时间"></asp:BoundColumn>
