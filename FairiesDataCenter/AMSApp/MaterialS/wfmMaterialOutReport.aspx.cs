...
{
	/// <summary>
	/// wfmMaterialOutReport 的摘要说明。
	/// </summary>
	public class wfmMaterialOutReport : wfmBase
	{
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			if(Session["Login"]!=null)
			{
				if (!IsPostBack )
				{
					this.ddlQueryType.Items.Add(new ListItem("原材料出库明细","0"));
					this.ddlQueryType.Items.Add(new ListItem("出库月报表","1"));
					this.ddlQueryType.Items.Add(new ListItem("出库汇总月报表","2"));
		...
		private void btnQuery_Click(object sender, System.EventArgs e)
		{
			...
			try
			{
				DataSet dsout=msb1.GetMaterialsOutReport(strQueryType,htpara);
