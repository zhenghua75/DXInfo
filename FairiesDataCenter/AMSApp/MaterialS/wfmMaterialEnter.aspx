<%@ Page language="c#" Codebehind="wfmMaterialEnter.aspx.cs" AutoEventWireup="false" Inherits="AMSApp.MaterialS.wfmMaterialEnter" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>wfmMaterialEnter</title>
				...
				<FORM id="Form1" method="post" runat="server">
					...
					<TABLE id="Table1" cellSpacing="10" cellPadding="5" width="60%" align="center" border="0">
						...
						<TR>
							...
							<TD style="WIDTH: 74px">
								<INPUT id="btnSelected" onclick="ShowHide('1',null);return false;" type="button" value="选择"
									style="WIDTH: 57px; HEIGHT: 24px"></TD>
						...
						<TR>
							...
							<TD><FONT face="宋体">
									<asp:TextBox id="txtUnit" runat="server" Height="24px" Width="137px" Font-Size="10pt"></asp:TextBox></FONT></TD>
						</TR>
						<TR>
							<TD style="FONT-SIZE: 10pt; WIDTH: 90px" align="right"><FONT face="宋体">单价</FONT></TD>
							<TD style="WIDTH: 136px">
								<asp:TextBox id="txtPrice" runat="server" Height="24px" Width="84px" Font-Size="10pt"></asp:TextBox>元</TD>
						...
						<TR>
							...
							<TD style="FONT-SIZE: 10pt; WIDTH: 136px" align="right">本次入库数量</TD>
							<TD style="WIDTH: 74px" colspan="2">
								<asp:TextBox id="txtEnterCount" runat="server" Height="24px" Width="136px" Font-Size="10pt"></asp:TextBox></TD>
							<TD></TD>
						</TR>
						<TR>
					...
					<div id="xMsg11" onmousedown="getFocus(this)">
						<div id="xMsg21" onmousedown="startDrag(this)" onmouseup="stopDrag(this)" onmousemove="drag(this)">
							<span id="xMsgs11">查询原材料</span> <span style="BORDER-TOP-WIDTH:0px;BORDER-LEFT-WIDTH:0px;BORDER-BOTTOM-WIDTH:0px;WIDTH:12px;COLOR:white;FONT-FAMILY:webdings;BORDER-RIGHT-WIDTH:0px"
						...
						<div id="xMsg31">
							<table align="center">
								<tr>
									<td style="FONT-SIZE: 8pt"><asp:Label id="Label7" runat="server">原材料编号：</asp:Label></td>
									<td style="FONT-SIZE: 8pt"><asp:TextBox id="txtQueryMaterialCode" runat="server"></asp:TextBox>
									</td>
									<td></td>
								</tr>
								<tr>
								...
								<tr>
									<td>
										<asp:DataGrid id="DataGrid1" runat="server" AutoGenerateColumns="False" BorderColor="#3366CC"
											BorderStyle="None" BorderWidth="1px" BackColor="White" CellPadding="4" Width="100%" Font-Size="8pt">
