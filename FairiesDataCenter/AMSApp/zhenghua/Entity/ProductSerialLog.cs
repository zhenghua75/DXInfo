...
namespace AMSApp.zhenghua.Entity
{
	...
	/// </summary>
	[Serializable]
	[TableMapping("tbProductSerialLog")]
	public class ProductSerialLog: EntityObjectBase
	{
		#region 数据表生成变量
		...
		private int _cnnProductSerialNo;
		...
		public ProductSerialLog():base()
		{
		}
		
		public ProductSerialLog(DataRow row):base(row)
		{
		}
		
		public ProductSerialLog(DataTable table):base(table)
		{
		}
		
		public ProductSerialLog(string  strXML):base(strXML)
		{
		}
		#endregion
		...
		/// 
		/// </summary>
		[ColumnMapping("cnnProductSerialNo",IsPrimaryKey=false,IsIdentity=false,IsVersionNumber=false)]
		public int cnnProductSerialNo
		{
			get {return _cnnProductSerialNo;}
			set {_cnnProductSerialNo = value;}
		}
