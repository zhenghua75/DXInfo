...
namespace AMSApp.zhenghua.Entity
{
	...
	/// </summary>
	[Serializable]
	[TableMapping("tbSalesSerial")]
	public class SalesSerial: EntityObjectBase
	{
		#region 数据表生成变量
		...
		public SalesSerial():base()
		{
		}
		
		public SalesSerial(DataRow row):base(row)
		{
		}
		
		public SalesSerial(DataTable table):base(table)
		{
		}
		
		public SalesSerial(string  strXML):base(strXML)
		{
		}
		#endregion
