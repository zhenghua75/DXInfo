...
namespace AMSApp.zhenghua.Entity
{
	...
	/// </summary>
	[Serializable]
	[TableMapping("tbProviderNew")]
	public class ProviderNew: EntityObjectBase
	{
		#region 数据表生成变量
		...
		public ProviderNew():base()
		{
		}
		
		public ProviderNew(DataRow row):base(row)
		{
		}
		
		public ProviderNew(DataTable table):base(table)
		{
		}
		
		public ProviderNew(string  strXML):base(strXML)
		{
		}
		#endregion
