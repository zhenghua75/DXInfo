...
namespace AMSApp.zhenghua.Entity
{
	...
	/// </summary>
	[Serializable]
	[TableMapping("tbCheckSerialLog")]
	public class CheckSerialLog: EntityObjectBase
	{
		#region 数据表生成变量
		...
		public CheckSerialLog():base()
		{
		}
		
		public CheckSerialLog(DataRow row):base(row)
		{
		}
		
		public CheckSerialLog(DataTable table):base(table)
		{
		}
		
		public CheckSerialLog(string  strXML):base(strXML)
		{
		}
		#endregion
		...
		/// 
		/// </summary>
		[ColumnMapping("cnnCheckSerialNo",IsPrimaryKey=false,IsIdentity=false,IsVersionNumber=false)]
		public int cnnCheckSerialNo
		{
			get {return _cnnCheckSerialNo;}
			set {_cnnCheckSerialNo = value;}
		}
