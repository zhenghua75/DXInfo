...
namespace AMSApp.zhenghua.Entity
{
	...
	/// </summary>
	[Serializable]
	[TableMapping("tbProductLostSerial")]
	public class ProductLostSerial: EntityObjectBase
	{
		#region 数据表生成变量
		...
		public ProductLostSerial():base()
		{
		}
		
		public ProductLostSerial(DataRow row):base(row)
		{
		}
		
		public ProductLostSerial(DataTable table):base(table)
		{
		}
		
		public ProductLostSerial(string  strXML):base(strXML)
		{
		}
		#endregion
