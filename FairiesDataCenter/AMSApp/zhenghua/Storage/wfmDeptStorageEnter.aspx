...
<%@ Page language="c#" Codebehind="wfmDeptStorageEnter.aspx.cs" AutoEventWireup="false" Inherits="AMSApp.zhenghua.Storage.wfmDeptStorageEnter" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>wfmDeptStorageEnter</title>
	...
	<body MS_POSITIONING="GridLayout" bgColor="#feeff8">
		<FORM id="Form1" method="post" runat="server">
			<TABLE id="Table3" border="0" cellSpacing="1" cellPadding="5" width="95%">
				<TR>
					<TD style="COLOR: #330033; FONT-SIZE: 15pt; FONT-WEIGHT: bold" align="center">分货入库</TD>
				</TR>
			</TABLE>
						...
						<TABLE id="Table2" border="0" cellSpacing="0" cellPadding="1" width="100%">
							<TR>
								<TD style="WIDTH: 84px" align="right">
									<asp:label style="Z-INDEX: 0" id="Label2" runat="server" Font-Size="10pt" Width="84px">分货入库单号</asp:label></TD>
								<TD style="WIDTH: 162px" align="left">
									<asp:textbox style="Z-INDEX: 0" id="txtEnterID" runat="server" Font-Size="10pt" Width="144px"></asp:textbox></TD>
            ...
            id=txtEnd onfocus=HS_setDate(this) value="<%=strEndDate%>" readOnly size=10 name=txtEnd></TD>
								...
								<TD>
									<asp:button style="Z-INDEX: 0" id="btnAdd" runat="server" Width="96px" Text="新分货入库单"></asp:button></TD>
							</TR>
						</TABLE>
					</TD>
				</TR>
