...
<%@ Page language="c#" Codebehind="wfmStorageBalanceReport.aspx.cs" AutoEventWireup="false" Inherits="AMSApp.zhenghua.Storage.wfmStorageBalanceReport" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>wfmStorageBalanceReport</title>
	...
	<body MS_POSITIONING="GridLayout" bgcolor="#feeff8">
		<FORM id="Form1" method="post" runat="server">
			<TABLE id="Table1" border="0" cellSpacing="1" cellPadding="5" width="95%">
				<TR>
					<TD style="COLOR: #330033; FONT-SIZE: 15pt; FONT-WEIGHT: bold" align="center">库存平衡关系报表</TD>
				</TR>
			</TABLE>
					...
					<TD>
						<TABLE id="Table2" border="0" cellSpacing="0" cellPadding="1" width="100%">
							<TR>
								...
								<TD style="WIDTH: 61px" align="right"></TD>
								<TD style="WIDTH: 173px; COLOR: red; FONT-SIZE: 10pt"></TD>
							...
							<TR>
								...
								<TD style="WIDTH: 101px">
									<asp:button style="Z-INDEX: 0" id="btnRefreshSTBA" runat="server" Width="96px" Height="23px"
										Text="刷新平衡数据"></asp:button></TD>
								<td></td>
							</TR>
						</TABLE>
					</TD>
