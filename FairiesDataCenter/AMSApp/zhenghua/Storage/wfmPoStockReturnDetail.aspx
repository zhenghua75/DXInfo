<%@ Page language="c#" Codebehind="wfmPoStockReturnDetail.aspx.cs" AutoEventWireup="false" Inherits="AMSApp.zhenghua.Storage.wfmPoStockReturnDetail" %>
<%@ Register TagPrefix="uc1" TagName="ucPageView" Src="../../ucPageView.ascx" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
  <HEAD>
		<title>wfmPoStockReturnDetail</title>
		...
		<DIV align="center" ms_positioning="text2D">
			<FORM id="Form1" method="post" runat="server">
				<TABLE id="Table3" border="0" cellSpacing="1" cellPadding="5" width="95%">
					<TR>
						<TD style="COLOR: #330033; FONT-SIZE: 15pt; FONT-WEIGHT: bold" align="center">采购退货单明细</TD>
					</TR>
				</TABLE>
							...
							<TABLE id="Table2" border="0" cellSpacing="0" cellPadding="1" width="100%">
								<TR>
									<TD style="WIDTH: 104px" align="right">
										<asp:label style="Z-INDEX: 0" id="Label2" runat="server" Width="85px" Font-Size="10pt">采购退货单号</asp:label></TD>
									<TD style="WIDTH: 166px" align="left">
										<asp:textbox style="Z-INDEX: 0" id="txtCode" runat="server" Width="160px" Font-Size="10pt"></asp:textbox></TD>
									<TD style="WIDTH: 86px" align="right">
										<asp:label style="Z-INDEX: 0" id="Label5" runat="server" Width="58px" Font-Size="10pt">部门</asp:label></TD>
									<TD style="WIDTH: 193px" align="left">
										<asp:dropdownlist style="Z-INDEX: 0" id="ddlDept" runat="server" Width="156px" Font-Size="10pt"></asp:dropdownlist></TD>
									<TD style="WIDTH: 151px" align="left"></TD>
									<TD style="WIDTH: 121px" align="left">
										<asp:textbox style="Z-INDEX: 0" id="txtRdID" runat="server" Width="62px" Font-Size="10pt"></asp:textbox></TD>
									<TD style="WIDTH: 136px"></TD>
									<TD>
<asp:textbox style="Z-INDEX: 0" id=txtgopage runat="server" Font-Size="10pt" Width="62px" Visible="False"></asp:textbox></TD>
								</TR>
								<TR>
									<TD style="WIDTH: 104px; HEIGHT: 17px" align="right"></TD>
									<TD style="WIDTH: 166px; HEIGHT: 17px; COLOR: blue; FONT-SIZE: 10pt" align="left"></TD>
									<TD style="WIDTH: 86px; HEIGHT: 17px" align="right">
										<asp:label style="Z-INDEX: 0" id="Label3" runat="server" Width="58px" Font-Size="10pt">仓库</asp:label></TD>
									<TD style="WIDTH: 193px; HEIGHT: 17px" align="left">
										<asp:dropdownlist style="Z-INDEX: 0" id="ddlWhouse" runat="server" Width="156px" Font-Size="10pt"
											Height="22px"></asp:dropdownlist></TD>
									<TD style="WIDTH: 151px; HEIGHT: 17px" align="left"><INPUT style="Z-INDEX: 0; WIDTH: 88px; HEIGHT: 24px" id="btnSelected" onclick="ShowHide('1',null);return false;"
											value="添加退货品" type="button" name="btnSelected"></TD>
									<TD style="WIDTH: 121px; HEIGHT: 17px" align="left">
										<asp:button style="Z-INDEX: 0" id="btnQuery" runat="server" Width="79px" Height="23px" Text="查询明细"></asp:button></TD>
									<TD style="WIDTH: 136px; HEIGHT: 17px">
										<asp:button style="Z-INDEX: 0" id="btEnterComf" runat="server" Width="78px" Height="24px" Text="确定退货"></asp:button></TD>
									<TD style="HEIGHT: 17px">
										<INPUT type="button" style="CURSOR:hand" value="返 回" onClick="javascript:window.history.go(<%=gopage%>);"></TD>
								</TR>
							</TABLE>
						</TD>
					</TR>
				...
				<TABLE id="Table4" border="0" cellSpacing="1" cellPadding="1" width="95%">
					<TR>
						<TD align="center">
							<asp:datagrid style="Z-INDEX: 0" id="Datagrid2" runat="server" Width="100%" Font-Size="X-Small"
								AutoGenerateColumns="False" BorderColor="Black" BorderWidth="1px" CellPadding="3" PagerStyle-HorizontalAlign="Right"
								Font-Name="Verdana" HeaderStyle-BackColor="SteelBlue" AlternatingItemStyle-BackColor="#660033"
								Font-Names="Verdana" AllowPaging="True" ForeColor="Blue" Caption="采购退货子单明细表" CaptionAlign="Left">
								...
								<Columns>
									...
									<asp:BoundColumn Visible="False" DataField="cnnRdID" ReadOnly="True" HeaderText="主表标识"></asp:BoundColumn>
									...
									<asp:BoundColumn DataField="cnvcComunitCode" ReadOnly="True" HeaderText="计量单位"></asp:BoundColumn>
									<asp:BoundColumn DataField="cnnEnterQuantity" ReadOnly="True" HeaderText="入库单数量"></asp:BoundColumn>
									<asp:BoundColumn DataField="cnnQuantity" HeaderText="退货数量"></asp:BoundColumn>
				...
				<DIV id="xMsg11" onmousedown="getFocus(this)">
					<DIV id="xMsg21" onmouseup="stopDrag(this)" onmousemove="drag(this)" onmousedown="startDrag(this)"><SPAN id="xMsgs11">查询采购入库单</SPAN>
						...
						<TABLE id="Table6" align="center">
							<TR>
								<TD style="FONT-SIZE: 8pt">
									<asp:label id="Label1" runat="server">采购入库单号：</asp:label></TD>
								<TD style="FONT-SIZE: 8pt">
									<asp:textbox id="txtQueryEnterCode" runat="server"></asp:textbox></TD>
								<TD></TD>
							</TR>
							<TR>
								<TD style="FONT-SIZE: 8pt">
									<asp:label id="Label11" runat="server">存货编码：</asp:label></TD>
								<TD style="FONT-SIZE: 8pt">
									<asp:textbox id="txtQueryGoodsCode" runat="server"></asp:textbox></TD>
								<TD>
							...
							<TR>
								<TD>
									<asp:datagrid id="DataGrid1" runat="server" Width="100%" Font-Size="8pt" AutoGenerateColumns="False"
										...
										<Columns>
											<asp:BoundColumn Visible="False" DataField="cnnAutoID" HeaderText="入库子表标识"></asp:BoundColumn>
											<asp:BoundColumn Visible="False" DataField="cnvcPoID" HeaderText="入库订单号"></asp:BoundColumn>
											<asp:BoundColumn DataField="cnvcCode" HeaderText="入库单号"></asp:BoundColumn>
											<asp:BoundColumn DataField="cndARVDate" HeaderText="入库日期"></asp:BoundColumn>
											<asp:BoundColumn Visible="False" DataField="cnvcProviderID" HeaderText="供应商编码"></asp:BoundColumn>
											<asp:BoundColumn DataField="cnvcProviderName" HeaderText="供应商"></asp:BoundColumn>
