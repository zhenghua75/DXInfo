<%@ Page language="c#" Codebehind="wfmInventoryMoveDetail.aspx.cs" AutoEventWireup="false" Inherits="AMSApp.zhenghua.Storage.wfmInventoryMoveDetail" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
  <HEAD>
		<title>wfmInventoryMoveDetail</title>
		...
		<DIV align="center" ms_positioning="text2D">
			<FORM id="Form1" method="post" runat="server">
				<TABLE id="Table3" border="0" cellSpacing="1" cellPadding="5" width="95%">
					<TR>
						<TD style="COLOR: #330033; FONT-SIZE: 15pt; FONT-WEIGHT: bold" align="center">调拨单明细</TD>
					</TR>
				</TABLE>
					...
					<TR>
						<TD>
							<TABLE id="Table2" border="0" cellSpacing="0" cellPadding="1" width="100%">
								<TR>
									<TD style="WIDTH: 104px" align="right"><asp:label style="Z-INDEX: 0" id="Label2" runat="server" Width="85px" Font-Size="10pt">调拨单号</asp:label></TD>
									...
									<TD style="WIDTH: 86px" align="right"><asp:label style="Z-INDEX: 0" id="Label5" runat="server" Width="58px" Font-Size="10pt">部门</asp:label></TD>
									<TD style="WIDTH: 194px" align="left"><asp:dropdownlist style="Z-INDEX: 0" id="ddlDept" runat="server" Width="155px" Font-Size="10pt"></asp:dropdownlist></TD>
									<TD style="WIDTH: 145px" align="left"></TD>
...
<asp:textbox style="Z-INDEX: 0" id=txtgopage runat="server" Font-Size="10pt" Width="62px" Visible="False"></asp:textbox></TD>
								...
								<TR>
									<TD style="WIDTH: 104px; HEIGHT: 17px" align="right">
										<asp:label style="Z-INDEX: 0" id="Label8" runat="server" Font-Size="10pt" Width="58px">单据类型</asp:label></TD>
									<TD style="WIDTH: 166px; HEIGHT: 17px; COLOR: blue; FONT-SIZE: 10pt" align="left">
										<asp:dropdownlist style="Z-INDEX: 0" id="ddlRdCode" runat="server" Font-Size="10pt" Width="155px"
											Height="22px"></asp:dropdownlist></TD>
									<TD style="WIDTH: 86px; HEIGHT: 17px" align="right"><asp:label style="Z-INDEX: 0" id="Label3" runat="server" Width="58px" Font-Size="10pt">仓库</asp:label></TD>
									<TD style="WIDTH: 194px; HEIGHT: 17px" align="left"><asp:dropdownlist style="Z-INDEX: 0" id="ddlWhouse" runat="server" Width="155px" Font-Size="10pt"
											Height="22px"></asp:dropdownlist></TD>
									<TD style="WIDTH: 145px; HEIGHT: 17px" align="left"><INPUT style="Z-INDEX: 0; WIDTH: 74px; HEIGHT: 24px" id="btnSelected" onclick="ShowHide('1',null);return false;"
											value="添加存货" type="button" name="btnSelected"></TD>
									...
									<TD style="WIDTH: 136px; HEIGHT: 17px"><asp:button style="Z-INDEX: 0" id="btEnterComf" runat="server" Width="78px" Height="24px" Text="确定出库"></asp:button></TD>
				...
				<TABLE id="Table4" border="0" cellSpacing="1" cellPadding="1" width="95%">
					<TR>
						<TD align="center"><asp:datagrid style="Z-INDEX: 0" id="Datagrid2" runat="server" Width="100%" Font-Size="X-Small"
								...
								AllowPaging="True" ForeColor="Blue" Caption="调拨子单明细表" CaptionAlign="Left">
								...
								<Columns>
									...
									<asp:BoundColumn Visible="False" DataField="cnnPrice" ReadOnly="True" HeaderText="单价"></asp:BoundColumn>
									<asp:BoundColumn DataField="cnvcComunitCode" ReadOnly="True" HeaderText="计量单位"></asp:BoundColumn>
									<asp:BoundColumn DataField="cnnOutCount" ReadOnly="True" HeaderText="出库数量"></asp:BoundColumn>
									<asp:BoundColumn DataField="cnnLostCount" HeaderText="损耗数量"></asp:BoundColumn>
									<asp:BoundColumn DataField="cnnQuantity" HeaderText="实际数量"></asp:BoundColumn>
									<asp:BoundColumn Visible="False" DataField="cnnCost" ReadOnly="True" HeaderText="金额"></asp:BoundColumn>
				...
				<DIV id="xMsg11" onmousedown="getFocus(this)">
					<DIV id="xMsg21" onmouseup="stopDrag(this)" onmousemove="drag(this)" onmousedown="startDrag(this)"><SPAN id="xMsgs11">查询存货</SPAN>
					...
					<DIV id="xMsg31">
						<TABLE id="Table6" align="center">
							<TR>
								<TD style="FONT-SIZE: 8pt"><asp:label id="Label1" runat="server">存货编码：</asp:label></TD>
							...
							<TR>
								<TD style="FONT-SIZE: 8pt"><asp:label id="Label6" runat="server">调拨数量：</asp:label></TD>
								<TD style="FONT-SIZE: 8pt"><asp:textbox id="txtMoveCount" runat="server"></asp:textbox></TD>
								<TD></TD>
							</TR>
						</TABLE>
						<TABLE id="Table7" width="100%" align="center">
							<TR>
								<TD><asp:datagrid id="DataGrid1" runat="server" Width="100%" Font-Size="8pt" AutoGenerateColumns="False"
										...
										<Columns>
											<asp:BoundColumn Visible="False" DataField="cnvcInvCode" HeaderText="存货编码"></asp:BoundColumn>
											<asp:BoundColumn DataField="cnvcInvName" HeaderText="存货名称"></asp:BoundColumn>
											<asp:BoundColumn Visible="False" DataField="cniInvCCost" HeaderText="参考成本"></asp:BoundColumn>
											<asp:BoundColumn Visible="False" DataField="cnvcGroupCode" HeaderText="计量单位组编码"></asp:BoundColumn>
											...
											<asp:BoundColumn DataField="cnnQuantity" HeaderText="可用库存数量"></asp:BoundColumn>
