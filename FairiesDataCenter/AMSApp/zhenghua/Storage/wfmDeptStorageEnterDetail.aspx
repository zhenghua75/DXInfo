<%@ Page language="c#" Codebehind="wfmDeptStorageEnterDetail.aspx.cs" AutoEventWireup="false" Inherits="AMSApp.zhenghua.Storage.wfmDeptStorageEnterDetail" %>
<%@ Register TagPrefix="uc1" TagName="ucPageView" Src="../../ucPageView.ascx" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
  <HEAD>
		<title>wfmDeptStorageEnterDetail</title>
		...
		<DIV align="center" ms_positioning="text2D">
			<FORM id="Form1" method="post" runat="server">
				<TABLE id="Table3" border="0" cellSpacing="1" cellPadding="5" width="95%">
					<TR>
						<TD style="COLOR: #330033; FONT-SIZE: 15pt; FONT-WEIGHT: bold" align="center">分货入库单明细</TD>
					</TR>
				</TABLE>
							...
							<TABLE id="Table2" border="0" cellSpacing="0" cellPadding="1" width="100%">
								<TR>
									<TD style="WIDTH: 104px" align="right">
										<asp:label style="Z-INDEX: 0" id="Label2" runat="server" Width="85px" Font-Size="10pt">分货入库单号</asp:label></TD>
									...
									<TD style="WIDTH: 139px" align="left">
										<asp:dropdownlist style="Z-INDEX: 0" id="ddlDept" runat="server" Width="129px" Font-Size="10pt"></asp:dropdownlist></TD>
...
<asp:textbox style="Z-INDEX: 0" id=txtgopage runat="server" Font-Size="10pt" Width="62px" Visible="False"></asp:textbox></TD>
								...
								<TR>
									...
									<TD style="WIDTH: 166px; HEIGHT: 17px; COLOR: blue; FONT-SIZE: 10pt" align="left">
										<asp:dropdownlist style="Z-INDEX: 0" id="ddlWhouse" runat="server" Width="129px" Font-Size="10pt"></asp:dropdownlist></TD>
									<TD style="WIDTH: 86px; HEIGHT: 17px" align="right"></TD>
									<TD style="WIDTH: 139px; HEIGHT: 17px" align="left"></TD>
									<TD style="WIDTH: 85px; HEIGHT: 17px" align="right"><INPUT style="Z-INDEX: 0; WIDTH: 106px; HEIGHT: 24px" id="btnSelected" onclick="ShowHide('1',null);return false;"
											value="关联生产分货单" type="button" name="btnSelected"></TD>
									...
									<TD style="WIDTH: 136px; HEIGHT: 17px">
										<asp:button style="Z-INDEX: 0" id="btEnterComf" runat="server" Width="78px" Height="24px" Text="确定入库"></asp:button></TD>
					...
					<TR>
						<TD align="center">
							<asp:datagrid style="Z-INDEX: 0" id="Datagrid2" runat="server" Width="100%" Font-Size="X-Small"
								...
								Font-Name="Verdana" HeaderStyle-BackColor="SteelBlue" AlternatingItemStyle-BackColor="#660033" OnPageIndexChanged="Datagrid2_PageIndexChanged"
								Font-Names="Verdana" AllowPaging="True" ForeColor="Blue" Caption="分货入库子单明细表" CaptionAlign="Left">
								...
								<Columns>
									...
									<asp:BoundColumn DataField="cnvcPOID" ReadOnly="True" HeaderText="对应分货流水"></asp:BoundColumn>
									...
									<asp:BoundColumn DataField="cnnPoCount" ReadOnly="True" HeaderText="分货数量"></asp:BoundColumn>
				...
				<DIV id="xMsg11" onmousedown="getFocus(this)">
					<DIV id="xMsg21" onmouseup="stopDrag(this)" onmousemove="drag(this)" onmousedown="startDrag(this)"><SPAN id="xMsgs11">查询生产分货单</SPAN>
						...
						<TABLE id="Table6" align="center">
							<TR>
								<TD style="FONT-SIZE: 8pt">
									<asp:label id="Label11" runat="server">生产分货单号：</asp:label></TD>
								<TD style="FONT-SIZE: 8pt">
									<asp:textbox id="txtQueryPoID" runat="server"></asp:textbox></TD>
								<TD>
							...
							<TR>
								<TD>
									<asp:datagrid id="DataGrid1" runat="server" Width="100%" Font-Size="8pt" AutoGenerateColumns="False"
										...
										<Columns>
											<asp:BoundColumn DataField="cnnAssignSerialNo" HeaderText="分货单号"></asp:BoundColumn>
											<asp:BoundColumn DataField="cnvcShipDeptID" HeaderText="发货单位"></asp:BoundColumn>
											<asp:BoundColumn DataField="cnvcShipOperID" HeaderText="发货人"></asp:BoundColumn>
											<asp:BoundColumn DataField="cnvcReceiveDeptID" HeaderText="收货单位"></asp:BoundColumn>
											<asp:BoundColumn DataField="cnvcReceiveOperID" HeaderText="收货人"></asp:BoundColumn>
