<%@ Page language="c#" Codebehind="wfmPoStockReturnAdd.aspx.cs" AutoEventWireup="false" Inherits="AMSApp.zhenghua.Storage.wfmPoStockReturnAdd" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>wfmPoStockReturnAdd</title>
			...
			<TABLE id="Table2" border="0" cellSpacing="1" cellPadding="5" width="700" align="center">
				<TR>
					<TD style="COLOR: #330033; FONT-SIZE: 15pt; FONT-WEIGHT: bold" align="center">
						<asp:Label id="lbltitle" runat="server" Width="347px" Height="24px">采购退货单内容</asp:Label></TD>
				</TR>
			</TABLE>
			<TABLE id="Table1" border="0" cellSpacing="10" cellPadding="5" width="700" align="center">
				<TR>
					<TD style="WIDTH: 90px; FONT-SIZE: 10pt" align="right">采购退货单号</TD>
				...
				<TR>
					...
					<TD style="WIDTH: 40px"></TD>
					<TD style="WIDTH: 107px; FONT-SIZE: 10pt" align="right">退货日期</TD>
