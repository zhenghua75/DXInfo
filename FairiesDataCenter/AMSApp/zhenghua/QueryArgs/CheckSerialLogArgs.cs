...
namespace AMSApp.zhenghua.QueryArgs
{
	...
	/// **功能名称：盘点入库流水表日志查询参数类
	/// </summary>
	public class CheckSerialLogArgs
	{
		/// <summary>
		/// 表名
		/// </summary>
		public string TableName = "tbCheckSerialLog";
		...
		/// 
		/// </summary>
		public QueryConditionField cnnCheckSerialNo = new QueryConditionField("cnnCheckSerialNo");
