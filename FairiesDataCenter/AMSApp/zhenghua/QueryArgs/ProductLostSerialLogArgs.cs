...
/******************************************************************** FR 1.20E *******
* 项目名称：   AMSApp
* 文件名:   	ProductLostSerialLogArgs.cs
* 作者:	     郑华
* 创建日期:    2009-7-24
* 功能描述:    产品报损流水表日志
...
namespace AMSApp.zhenghua.QueryArgs
{
	...
	/// **功能名称：产品报损流水表日志查询参数类
	/// </summary>
	public class ProductLostSerialLogArgs
	{
		/// <summary>
		/// 表名
		/// </summary>
		public string TableName = "tbProductLostSerialLog";
		...
		/// 
		/// </summary>
		public QueryConditionField cnnProductLostSerialNo = new QueryConditionField("cnnProductLostSerialNo");
