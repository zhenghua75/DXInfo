<%@ Page language="c#" Codebehind="wfmAdjustSales.aspx.cs" AutoEventWireup="false" Inherits="AMSApp.zhenghua.Lj.wfmAdjustSales" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>wfmAdjustSales</title>
	...
	<body MS_POSITIONING="GridLayout" bgcolor="#feeff8">
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table1" cellSpacing="1" cellPadding="5" width="95%" border="0">
				<TR>
					<TD style="FONT-WEIGHT: bold; FONT-SIZE: 15pt; COLOR: #330033" align="center">销售产品调整</TD>
				</TR>
			</TABLE>
			<TABLE id="Table2" cellSpacing="1" cellPadding="1" width="95%" border="1">
					...
					<td align="center">
						<table cellSpacing="1" cellPadding="1" border="0">
							<TR>
								...
								<td>
									<asp:Button id="btnQuery" runat="server" Text="销售产品查询"></asp:Button></td>
							</TR>
						</table>
					</td>
				</tr>
				<tr vAlign="top">
					<td align="center"><ASP:DATAGRID id="MyDataGrid" runat="server" AllowPaging="True" PagerStyle-Mode="NumericPages"
							...
							<Columns>
								<asp:BoundColumn DataField="cnnSerialNo" ReadOnly="True" HeaderText="销售序号"></asp:BoundColumn>
								...
								<asp:BoundColumn DataField="cnnCount" ReadOnly="True" HeaderText="销售量"></asp:BoundColumn>
