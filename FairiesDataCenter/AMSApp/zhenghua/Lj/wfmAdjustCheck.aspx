<%@ Page language="c#" Codebehind="wfmAdjustCheck.aspx.cs" AutoEventWireup="false" Inherits="AMSApp.zhenghua.Lj.wfmAdjustCheck" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>wfmAdjustCheck</title>
	...
	<body MS_POSITIONING="GridLayout" bgcolor="#feeff8">
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table1" cellSpacing="1" cellPadding="5" width="95%" border="0">
				<TR>
					<TD style="FONT-WEIGHT: bold; FONT-SIZE: 15pt; COLOR: #330033" align="center">销售盘点入库产品调整</TD>
				</TR>
			</TABLE>
			<TABLE id="Table2" cellSpacing="1" cellPadding="1" width="95%" border="1">
				<tr vAlign="top">
					<td align="center">
						<table cellSpacing="1" cellPadding="1" border="0">
							<TR>
								<TD><asp:label id="Label3" runat="server">盘点部门：</asp:label></TD>
								...
								<td>
									<asp:Button id="btnQuery" runat="server" Text="盘点产品查询"></asp:Button></td>
							</TR>
						</table>
					</td>
				</tr>
				<tr vAlign="top">
					<td align="center"><ASP:DATAGRID id="MyDataGrid" runat="server" AllowPaging="True" PagerStyle-Mode="NumericPages"
							...
							<Columns>
								<asp:BoundColumn DataField="cnnSerialNo" ReadOnly="True" HeaderText="盘点序号"></asp:BoundColumn>
								...
								<asp:BoundColumn DataField="cnnCount" ReadOnly="True" HeaderText="盘点量"></asp:BoundColumn>
								...
								<asp:BoundColumn DataField="cndCreateDate" ReadOnly="True" HeaderText="盘点日期"></asp:BoundColumn>
								<asp:TemplateColumn HeaderText="是否继续销售">
									<ItemTemplate>
										<asp:Label id=Label6 runat="server" Text='<%# GetIsSales(DataBinder.Eval(Container, "DataItem.cnbIsSales").ToString())%>'>
										</asp:Label>
									</ItemTemplate>									
								</asp:TemplateColumn>
								<asp:TemplateColumn>
									<ItemTemplate>
										<asp:LinkButton runat="server" Text="调增" CommandName="AdjustAdd" CausesValidation="false" ID="Linkbutton1"
											NAME="Linkbutton1"></asp:LinkButton>
									</ItemTemplate>
								</asp:TemplateColumn>
								<asp:TemplateColumn>
									<ItemTemplate>
										<asp:LinkButton runat="server" Text="调减" CommandName="AdjustReduce" CausesValidation="false" ID="Linkbutton2"
