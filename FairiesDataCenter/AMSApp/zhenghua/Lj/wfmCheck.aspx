<%@ Page language="c#" Codebehind="wfmCheck.aspx.cs" AutoEventWireup="false" Inherits="AMSApp.zhenghua.Lj.wfmCheck" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
  <HEAD>
		<title>wfmCheck</title>
	...
	<body MS_POSITIONING="GridLayout" bgcolor="#feeff8">
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table1" cellSpacing="1" cellPadding="5" width="95%" border="0">
				<TR>
					<TD style="FONT-WEIGHT: bold; FONT-SIZE: 15pt; COLOR: #330033" align="center">销售盘点入库</TD>
				</TR>
			</TABLE>
			<TABLE id="Table2" cellSpacing="1" cellPadding="1" width="95%" border="1">
						...
						<TABLE id="Table3" cellSpacing="1" cellPadding="1" border="0">
							<TR>
								...
								<td>
									...
									<asp:CheckBox id="chkIsSales" runat="server" Text="继续销售"></asp:CheckBox>
								</td>
								<td>
									<asp:button id="Button1" runat="server" Text="添加产品"></asp:button></td>
							</TR>
						</TABLE>
					</TD>
				</TR>
					...
					<td align="center"><ASP:DATAGRID id="MyDataGrid" runat="server" AllowPaging="True" PagerStyle-Mode="NumericPages"
							...
							<Columns>
								...
								<asp:TemplateColumn HeaderText="是否继续销售">
									...
									<EditItemTemplate>
										<asp:CheckBox id="CheckBox1" runat="server" Checked='<%# DataBinder.Eval(Container, "DataItem.cnbIsSales") %>'></asp:CheckBox>
									</EditItemTemplate>
								</asp:TemplateColumn>
					...
					<td align="center">
						<table cellSpacing="1" cellPadding="1" border="0">
							<TR>
								...
								<TD align="center"><asp:label id="Label2" runat="server">盘点日期：</asp:label></TD>
				...
				<tr vAlign="top">
					<td align="center">
						<asp:Button id="Button2" runat="server" Text="盘点入库"></asp:Button>
					</td>
				</tr>
			</TABLE>
		</form>
