...
namespace AMSApp.zhenghua.Lj.Report
{
	...
	/// wfmSalesSum 的摘要说明。
	/// </summary>
	public class wfmSalesSum : wfmBase
	{
		...
		private void Button2_Click(object sender, System.EventArgs e)
		{
			...
			{
				strSql = "select cnvcDeptID as '销售部门',cnvcCode as '产品编码',cnvcName as '产品名称',sum(cnnCount+cnnAddCount-cnnReduceCount) as '销售数量' from tbSalesSerial where convert(char(10),cndCreateDate,121) >= '"+txtBeginDate.Text+"' and  "
