...
namespace AMSApp.zhenghua.Lj.Report
{
	...
	/// wfmSalesList 的摘要说明。
	/// </summary>
	public class wfmSalesList : wfmBase
	{
		...
		private void Button2_Click(object sender, System.EventArgs e)
		{
			...
			{
				strSql = "select cnnSerialNo as '销售序号',cnvcCode as '产品编码',cnvcName as '产品名称',cnnCount+cnnAddCount-cnnReduceCount as '销售数量',convert(char(10),cndCreateDate,121) as '销售日期',cnvcDeptID as '销售部门',cnvcOperID as '操作员',cndOperDate as '操作日期' from tbSalesSerial where convert(char(10),cndCreateDate,121) >= '"+txtBeginDate.Text+"' and  "
			...
			this.TableConvert(dtOut,"销售部门","tbCommCode","vcCommCode","vcCommName","vcCommSign='MD'");
			this.TableConvert(dtOut,"操作员","tbLogin","vcLoginID","vcOperName");
			//			this.CodeConvert(dtOut,"销售部门","tbCommCode","vcCommSign='MD'");
