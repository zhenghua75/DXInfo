...
<%@ Page language="c#" Codebehind="wfmProduceLogReport.aspx.cs" AutoEventWireup="false" Inherits="AMSApp.zhenghua.Lj.Report.wfmProduceLogReport" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>wfmProduceLogReport</title>
	...
	<body MS_POSITIONING="GridLayout" bgcolor="#feeff8">
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table1" cellSpacing="1" cellPadding="5" width="95%" border="0">
				<TR>
					<TD style="FONT-WEIGHT: bold; FONT-SIZE: 15pt; COLOR: #330033" align="center">生产操作日志报表</TD>
				</TR>
			</TABLE>
