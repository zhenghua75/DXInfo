...
namespace AMSApp.zhenghua.Lj
{
	...
	/// wfmAddSales 的摘要说明。
	/// </summary>
	public class wfmAddSales : wfmBase
	{
		...
		{
			Session["tbSalesSerial"] = dtProduct;
		}
		public DataTable GetProduct()
		{
			DataTable dtProduct = null;			
			if(Session["tbSalesSerial"] != null)
			{
				dtProduct = (DataTable) Session["tbSalesSerial"];
			}
			else
			{
				dtProduct = Helper.Query("select * from tbSalesSerial where 1<>1");
				Session["tbSalesSerial"] = dtProduct;
			}
			return dtProduct;
		}
