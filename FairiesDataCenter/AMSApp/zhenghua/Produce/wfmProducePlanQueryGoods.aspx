<%@ Page language="c#" Codebehind="wfmProducePlanQueryGoods.aspx.cs" AutoEventWireup="false" Inherits="AMSApp.zhenghua.Produce.wfmProducePlanQueryGoods" %>
			...
			<table align="center" width="100%">
				...
				<tr>
					<td colSpan="6" align="center"><asp:button id="btnQuery" runat="server" CssClass="button" Text="查询"></asp:button><asp:button id="btnCancel" runat="server" CssClass="button" Text="取消"></asp:button>
						<asp:Button id="btnDept" runat="server" Text="部门分货优先级调整" CssClass="button" Width="123px"></asp:Button></td>
				</tr>
			</table></td></tr></table>
