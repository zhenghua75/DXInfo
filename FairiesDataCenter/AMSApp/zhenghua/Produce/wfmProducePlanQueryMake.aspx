<%@ Page language="c#" Codebehind="wfmProducePlanQueryMake.aspx.cs" AutoEventWireup="false" Inherits="AMSApp.zhenghua.Produce.wfmProducePlanQueryMake" %>
	...
	<body MS_POSITIONING="GridLayout" bgcolor="#feeff8">
		<form id="Form1" method="post" runat="server">
			<table align="center">
				<tr>
					<td>
						<asp:Label id="Label1" runat="server" CssClass="title">生产预估</asp:Label></td>
				</tr>
			</table>
...
<ItemTemplate>
<asp:CheckBox id=CheckBox1 runat="server" Checked='<%# DataBinder.Eval(Container, "DataItem.cnbSelf") %>' Enabled="False"></asp:CheckBox>
</ItemTemplate>

<EditItemTemplate>
<asp:TextBox id=TextBox1 runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.cnbSelf") %>'></asp:TextBox>
</EditItemTemplate>
</asp:TemplateColumn>
								...
								<asp:HyperLinkColumn Text="预估" DataNavigateUrlField="cnnProduceSerialNo" DataNavigateUrlFormatString="wfmMakeLog.aspx?OperType=Make&amp;ProduceSerialNo={0}"
									HeaderText="预估"></asp:HyperLinkColumn>
							</Columns>
