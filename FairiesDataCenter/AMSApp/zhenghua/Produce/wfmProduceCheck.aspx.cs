...
namespace AMSApp.zhenghua.Produce
{
	...
	/// </summary>
	public class wfmProduceCheck : wfmBase
	{
		#region 字段
...
//			strSql += " left outer join tbLogin d on a.cnvcOperID=d.vcLoginID";
			strSql += " where cnvcProduceState in ('3','4') and cnvcProduceDeptID like '"+ddlProduceDept.SelectedValue+"'";
...
//			} 
		...
		{
			this.Response.Redirect("../Warhouse/wfmTeam.aspx");
		}

		private void Button2_Click(object sender, System.EventArgs e)
		{
			this.Response.Redirect("../Warhouse/wfmProducer.aspx");
		}
	}
}
