...
{
	/// <summary>
	/// wfmProduceCheckWh 的摘要说明。
	/// </summary>
	public class wfmProduceCheckWh : wfmBase
	{
		...
		private void BindGrid()
		{
			...
			strSql += " where cnvcProduceState in('4','5','8') and cnvcProduceDeptID like '"+ddlProduceDept.SelectedValue+"'";
