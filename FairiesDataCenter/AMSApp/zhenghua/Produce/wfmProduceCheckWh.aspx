<%@ Page language="c#" Codebehind="wfmProduceCheckWh.aspx.cs" AutoEventWireup="false" Inherits="AMSApp.zhenghua.Produce.wfmProduceCheckWh" %>
...
<HTML>
	...
	<body bgColor="#feeff8" MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<table align="center">
				<tr>
					<td><asp:label id="Label1" runat="server" CssClass="title">生产入库</asp:label></td>
				</tr>
			</table>
				...
				<tr>
					<td>
						<table align="center" width="100%">
							...
							<tr>
								<td colSpan="6" align="center"><asp:button id="btnQuery" runat="server" CssClass="button" Text="查询"></asp:button><asp:button id="btnCancel" runat="server" CssClass="button" Text="取消"></asp:button></td>
							</tr>
						</table>
					</td>
				</tr>
				...
				<tr>
					<td align="center"><asp:datagrid id="DataGrid1" runat="server" CssClass="datagrid" BorderColor="Black" BorderWidth="1px"
							...
							<Columns>
								...
								<asp:HyperLinkColumn Text="生产入库" Target="_self" DataNavigateUrlField="cnnProduceSerialNo" DataNavigateUrlFormatString="wfmCheckInWh.aspx?ProduceSerialNo={0}"
									HeaderText="生产入库"></asp:HyperLinkColumn>
							</Columns>
