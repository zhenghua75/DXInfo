...
namespace AMSApp.BusiQuery
{
	...
	/// </summary>
	public partial class wfmFillMdQuery : wfmBase
	{
...
//				}
				if (!IsPostBack )
				{
					...
					this.FillDropDownList("tbCommCode", this.DropDownList1, "vcCommSign ='MD'","全部");
					if(ls1.strLimit!="CL001")
					{
		...
		protected void btQuery_Click(object sender, System.EventArgs e)
		{
			...
			{
				double dsum=0;
				DataTable dtout=busiq.GetFillQueryMd(htPara);
				...
				this.lblSum.Text="金额汇总："+dsum.ToString()+"元";
