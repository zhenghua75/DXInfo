IF  not EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[tbConsItemHis]') AND type in (N'U'))
begin
CREATE TABLE [dbo].[tbConsItemHis](
 ...
 CONSTRAINT [PK_TBCONSITEMHIS] PRIMARY KEY CLUSTERED 
(
	[iSerial] ASC,
	[vcGoodsID] ASC
)
