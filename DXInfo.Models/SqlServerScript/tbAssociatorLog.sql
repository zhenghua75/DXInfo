IF  not EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[tbAssociatorLog]') AND type in (N'U'))
begin
CREATE TABLE [dbo].[tbAssociatorLog](
	...
	[vcOperDeptID] [varchar](5) NOT NULL,
