...
namespace DXInfo.Web.Controllers
{
    ...
    public class WesternRestaurantController : BaseController
    {
        ...
        private void SetupRoomGridModel(JQGrid grid)
        {
            ...
            SetRequiredColumn(grid, "DeptId");
            SetRequiredColumn(grid, "Code");
            SetRequiredColumn(grid, "Name");
            SetRequiredColumn(grid, "Status");
        }
        ...
        private void SetupDeskGridModel(DeskGridModel gridModel)
        {
            ...
            SetRequiredColumn(grid, "RoomId");
            SetRequiredColumn(grid, "Code");
            SetRequiredColumn(grid, "Name");
            SetRequiredColumn(grid, "Size");
            SetRequiredColumn(grid, "Status");
        }
