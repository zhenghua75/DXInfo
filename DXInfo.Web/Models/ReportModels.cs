...
namespace DXInfo.Web.Models
{
    ...
    public class ReportBaseGridModel : ReportBaseModel
    {
    ...
    #region Report2
    public class Report2GridModel:ReportBaseGridModel
    {
    ...
    public class Report4Model:ReportBaseModel
    {
        [Display(Name = "门店：")]
        public Guid? DeptId { get; set; }
    ...
    public class Report5Model:ReportBaseModel
    {
        [Display(Name = "门店：")]
        public Guid? DeptId { get; set; }
        public bool IsDept { get; set; }
    ...
    #region Report10
    public class Report10Model:ReportBaseModel
    {
        [Display(Name = "开始日期：")]
        [Required]
        public string BeginDate { get; set; }
    ...
    #endregion
    #region Report11
    public class Report11Model:ReportBaseModel
    {
        [Display(Name = "开始日期：")]
        [Required]
        public string BeginDate { get; set; }
    ...
    #region Report14
    public class Report14Model:ReportBaseModel
    {
        [Display(Name = "门店：")]
        public Guid? DeptId { get; set; }
        [Display(Name = "操作员：")]
    ...
    public class WRReport4Model:ReportBaseModel
    {
        [Display(Name = "门店：")]
        public Guid? DeptId { get; set; }
        public bool IsDept { get; set; }
    ...
    public class WRReport5Model:ReportBaseModel
    {
        [Display(Name = "门店：")]
        public Guid? DeptId { get; set; }
        public bool IsDept { get; set; }
    ...
    #region WRReport10
    public class WRReport10Model:ReportBaseModel
    {
        [Display(Name = "开始日期：")]
        [Required]
        public string BeginDate { get; set; }
    ...
    #endregion
    #region WRReport11
    public class WRReport11Model:ReportBaseModel
    {
        [Display(Name = "开始日期：")]
        [Required]
        public string BeginDate { get; set; }
    ...
    #region WRReport14
    public class WRReport14Model:ReportBaseModel
    {
        [Display(Name = "门店：")]
        public Guid? DeptId { get; set; }
    ...
    #region WRReport15
    public class WRReport15Model:ReportBaseModel
    {
        [Display(Name = "开始日期：")]
        [Required]
        public string BeginDate { get; set; }
    ...
    #region WRReport20
    public class WRReport20GridModel
    {
        public JQGrid WRReportGrid { get; set; }
        public WRReport20GridModel()
        {
            WRReportGrid = new JQGrid()
            {
                Columns = new List<JQGridColumn>()
