...
namespace DXInfo.Data.Configuration
{
    ...
    public class OrderBookDeskesHisConfiguration : EntityTypeConfiguration<OrderBookDeskesHis>
    {
        
        public OrderBookDeskesHisConfiguration()
        {
            this.HasKey(k => k.Id);
            ...
            this.Property(o => o.OrderBookId).IsRequired();
            this.Property(o => o.DeskId).IsRequired();
