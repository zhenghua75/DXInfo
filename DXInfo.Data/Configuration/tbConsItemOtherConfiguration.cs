...
namespace DXInfo.Data.Configuration
{
    ...
    public class tbConsItemOtherConfiguration : EntityTypeConfiguration<tbConsItemOther>
    {
        
        public tbConsItemOtherConfiguration()
        {
            this.HasKey(k => new { k.iSerial,k.vcGoodsID,k.vcDeptID });
