...
namespace DXInfo.Data.Configuration
{
    ...
    public class PlayListsConfiguration : EntityTypeConfiguration<PlayLists>
    {
        
        public PlayListsConfiguration()
        {
            this.HasKey(k => k.Id);
            ...
            this.Property(o => o.BeginTime).IsRequired();
            this.Property(o => o.EndTime).IsRequired();
            this.Property(o => o.IsEnabled).IsRequired();
        }
    }
}
