...
namespace DXInfo.Data.Configuration
{
    ...
    public class OrderBooksHisConfiguration : EntityTypeConfiguration<OrderBooksHis>
    {
        
        public OrderBooksHisConfiguration()
        {
            this.HasKey(k => k.Id);
            ...
            this.Property(o => o.BookBeginDate).IsRequired();
            this.Property(o => o.BookEndDate).IsRequired();
            this.Property(o => o.Quantity).IsRequired();
            this.Property(o => o.Customer).IsRequired();
            this.Property(o => o.Customer).IsUnicode();
            this.Property(o => o.Customer).HasMaxLength(50);
            this.Property(o => o.LinkPhone).IsRequired();
            this.Property(o => o.LinkPhone).IsUnicode();
            this.Property(o => o.LinkPhone).HasMaxLength(50);
