...
namespace DXInfo.Data.Configuration
{
    ...
    public class BillOfMaterialsConfiguration : EntityTypeConfiguration<BillOfMaterials>
    {
        ...
        public BillOfMaterialsConfiguration()
        {
            ...
            this.Property(o => o.PartInvId).IsRequired();
            this.Property(o => o.ComponentInvId).IsRequired();
            this.Property(o => o.BaseQtyN).HasPrecision(24,9);
            this.Property(o => o.BaseQtyN).IsRequired();
            this.Property(o => o.BaseQtyD).HasPrecision(24,9);
            this.Property(o => o.BaseQtyD).IsRequired();
        }
    }
}
