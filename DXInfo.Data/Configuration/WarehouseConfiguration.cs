...
namespace DXInfo.Data.Configuration
{
    ...
    public class WarehouseConfiguration : EntityTypeConfiguration<Warehouse>
    {
        ...
        public WarehouseConfiguration()
        {
            ...
            this.Property(o => o.Code).HasMaxLength(200);
            this.Property(o => o.Name).IsRequired();
            this.Property(o => o.Name).IsUnicode();
            this.Property(o => o.Name).HasMaxLength(200);
            this.Property(o => o.Dept).IsRequired();
            this.Property(o => o.Principal).IsUnicode();
            this.Property(o => o.Principal).HasMaxLength(200);
            this.Property(o => o.Tele).IsUnicode();
            this.Property(o => o.Tele).HasMaxLength(200);
