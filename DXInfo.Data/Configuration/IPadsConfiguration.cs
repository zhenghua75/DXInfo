...
namespace DXInfo.Data.Configuration
{
    ...
    public class IPadsConfiguration : EntityTypeConfiguration<IPads>
    {
        
        public IPadsConfiguration()
        {
            this.HasKey(k => k.Id);
            ...
            this.Property(o => o.SN).IsUnicode();
            this.Property(o => o.SN).HasMaxLength(50);
