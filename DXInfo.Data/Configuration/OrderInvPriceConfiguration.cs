...
namespace DXInfo.Data.Configuration
{
    ...
    public class OrderInvPriceConfiguration : EntityTypeConfiguration<OrderInvPrice>
    {        
        public OrderInvPriceConfiguration()
        {
            this.HasKey(k => k.Id);
            ...
            this.Property(o => o.OrderMenuId).IsRequired();
        }
    }
}
