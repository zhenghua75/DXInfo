...
namespace DXInfo.Data.Configuration
{
    ...
    public class CardLevelsConfiguration : EntityTypeConfiguration<CardLevels>
    {
        
        public CardLevelsConfiguration()
        {
            this.HasKey(k => k.Id);
            ...
            this.Property(o => o.BeginLetter).IsUnicode();
            this.Property(o => o.BeginLetter).HasMaxLength(50);
