...
namespace DXInfo.Data.Configuration
{
    ...
    public class DesksConfiguration : EntityTypeConfiguration<Desks>
    {
        
        public DesksConfiguration()
        {
            this.HasKey(k => k.Id);
            this.Property(o => o.Id).HasDatabaseGeneratedOption(DatabaseGeneratedOption.Identity);
            this.Property(o => o.Id).IsRequired();
            this.Property(o => o.RoomId).IsRequired();
            ...
            this.Property(o => o.Size).IsRequired();
