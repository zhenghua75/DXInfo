...
namespace DXInfo.Data.Configuration
{
    ...
    public class CardTypesConfiguration : EntityTypeConfiguration<CardTypes>
    {
        
        public CardTypesConfiguration()
        {
            this.HasKey(k => k.Id);
            ...
            this.Property(o => o.IsMoney).IsRequired();
            this.Property(o => o.IsVirtual).IsRequired();
            this.Property(o => o.CardNoRule).HasMaxLength(200);
        }
    }
}
