...
namespace DXInfo.Data.Configuration
{
    ...
    public class VendorConfiguration : EntityTypeConfiguration<Vendor>
    {
        ...
        public VendorConfiguration()
        {
            ...
            this.Property(o => o.Tel).HasMaxLength(50);
            this.Property(o => o.Fax).HasMaxLength(50);
            this.Property(o => o.Phone).HasMaxLength(50);
            this.Property(o => o.Zip).HasMaxLength(50);
            this.Property(o => o.Linkman).IsUnicode();
            this.Property(o => o.Linkman).HasMaxLength(200);
            this.Property(o => o.Address).IsUnicode();
            this.Property(o => o.Address).HasMaxLength(200);
            this.Property(o => o.Email).HasMaxLength(50);
            this.Property(o => o.VendorType).IsRequired();
        }
    }
}
