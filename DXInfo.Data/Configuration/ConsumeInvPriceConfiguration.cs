...
namespace DXInfo.Data.Configuration
{
    ...
    public class ConsumeInvPriceConfiguration : EntityTypeConfiguration<ConsumeInvPrice>
    {
        
        public ConsumeInvPriceConfiguration()
        {
            this.HasKey(k => k.Id);
            ...
            this.Property(o => o.InvPriceId).IsRequired();
