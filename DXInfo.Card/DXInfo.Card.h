...
public:
	...
	__int16 CancelRechargeCard(unsigned char data[33],unsigned long value);
	__int16 ConsumeCard(unsigned char data[33],unsigned long value);
	__int16 CancelConsumeCard(unsigned char data[33],unsigned long value);
	__int16 RecycleCard();
private:
	HANDLE icdev;
	long m_baund;
...
extern "C" DXINFOCARD_API __int16 __stdcall CancelCoolerRechargeCard(unsigned char data[33],unsigned long value);
extern "C" DXINFOCARD_API __int16 __stdcall CoolerConsumeCard(unsigned char data[33],unsigned long value);
extern "C" DXINFOCARD_API __int16 __stdcall CancelCoolerConsumeCard(unsigned char data[33],unsigned long value);
